...
"%PY%" -m pip install --upgrade numpy opencv-python pillow astropy rawpy PySide6
if not %ERRORLEVEL%==0 goto :pipfail
...
"%PY%" -c "import cv2, numpy, rawpy; from PIL import Image; from astropy.io import fits; from PySide6.QtWidgets import QApplication; print('Base dependencies OK')"
if not %ERRORLEVEL%==0 (
